...
const ItemCard: React.FC<ItemCardProps> = ({ item }) => {
  ...
  return (
    <div 
      className="card cursor-pointer transform hover:scale-[1.02] transition-all duration-300 overflow-hidden group"
      onClick={handleClick}
    >
      ...
      <div className="p-4 sm:p-5">
        <div className="flex items-start justify-between mb-3">
          <h3 className="text-lg sm:text-xl font-bold text-gray-900 line-clamp-2 flex-1 mr-2 group-hover:text-blue-600 transition-colors duration-300">
            {item.name}
          </h3>
        </div>
